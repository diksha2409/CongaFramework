...
//req for 1st scenario when we dnt knw the URL and dnt knw the app id
	private String URL_WITHOUT_API_UNKNOWN = "https://samples.openweathermap.org/data/3.0/stations";
//	//req for 1st scenario when we knw the URL and knw the app id
...
//	when we have to add appid on url to authenticate
...
//	to call endpoint EX: Postman url hit same scenario
...
//	    for post req bcz we need response object in json
	    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
//	     we sending the stations in json thts why we specified here
